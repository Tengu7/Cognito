...
var cards = [
	{
		"title": "The Fool",
		"story": "WHAT IS ZERO?",
		"image": "res://assets/Fool.png",
		"image_back": "res://assets/CardBack.png",
		"choices": [
			{"text": "Everything", "result": "Kings of what? Nothing. We are ever hungry while THEY bleed freely. Our fountain of youth is bieng diluted by grease and sugar and salt. Our lives are FOOLISH lives."},
	...
	},
	{
		...
		"image": "res://assets/High_Priestess_.png",
		"image_back": "res://assets/CardBack.png",
		"choices": [
			{"text": "Take his hand", "result": "Your skin settles. You tremble on two legs as he leads you to your throne."},
			{"text": "Turn away", "result": "For a brief moment, hurt flashes on his face. Then he turns both monsterous and beautiful, and snarls FINE, SLITHER THEN. You tremble, then slither after him as he stomps away."}
		]
	},
	{
		"title": "The Emperess",
	...
	},
	{
		...
		"image": "res://assets/Hierophant.png",
		"image_back": "res://assets/CardBack.png",
		"choices": [
	...
	},
	{
		...
		"image": "res://assets/Wheel_Of_Fortune.png",
		"image_back": "res://assets/CardBack.png",
		"choices": [
